...
TEAMS_COLOR_SCALE <- c("grey", "#B3995D","black","#03202F","#0B2265","#fb9a99","#A5ACAF","#0085CA",
  "#ff7f00","#203731","#6a3d9a","#A71930","#A71930","#FFB612","#004953","#FF0000", "#00FF00")
...
plotProjections(projections, "WR", "Wide Receivers", "week 9",(6*16))
...
plotProjections(projections, "RB", "Running Backs", "week 9", (6*16))
...
plotProjections(projections, "TE", "Tight Ends", "week 9",(4*14))
...
plotProjections(projections, "K", "Kickers", "week 9",(32))
...
plotDFAProjections(dudes_projections, "WR",(6*14))
...
plotDFAProjections(dudes_projections, "RB", (6*14))
...
plotDFAProjections(dudes_projections, "TE",(4*14))
...
plotDFAProjections(dudes_projections, "K",(32))
